 ...
 * be run when the activity is being launched and exited. When launching, the
 * large version of the picture will resize from the thumbnail version in the
...
public class PictureDetailsActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		Logger.info("Thumbnails", thumbnailLeft + "," + thumbnailWidth + ","
		...
		mBackground = new ColorDrawable(getResources().getColor(
				R.color.xebia_color));
			...
			observer.addOnPreDrawListener(new ViewTreeObserver.OnPreDrawListener() {
				...
				public boolean onPreDraw() {
					...
					mHeightScale = (float) thumbnailHeight
							/ (mImageView.getHeight()+75);

					Logger.info("Deltas", "mLaeftDelta:" + mLeftDelta
							+ ", mTopDelta:" + mTopDelta + ", mWidthScale:"
							+ mWidthScale + ", mHeightScale:" + mHeightScale+", Image Width:"+mImageView.getWidth()+",mImageHeight:"+mImageView.getHeight());
		...
		mImageView.setPostImageDrawListener(new postImageDrawListener() {
